 ...
 * @since      1.0.0
 *
 * @package    Dsbugreport_Plugin
 * @subpackage Dsbugreport_Plugin/admin
 */
 ...
 *
 */
class Dsbugreport_Admin_Settings {
	...
	public function setup_plugin_options_menu() {
		...
		add_plugins_page(
			'DS Bug Report Options', 					// The title to be displayed in the browser window for this page.
			'DS Bug Report Options',					// The text to be displayed for this menu item
			'manage_options',					// Which type of users can see this menu item
			'Dsbugreport_options',			// The unique ID - that is, the slug - for this menu item
	...
	public function render_settings_page_content( $active_tab = '' ) {
		...
		<div class="wrap">
			...
			<h2><?php _e( 'DS Bug Report Options', 'wppb-demo-plugin' ); ?></h2>
			<?php settings_errors(); ?>
			...
			<h2 class="nav-tab-wrapper">
				<a href="?page=Dsbugreport_options&tab=display_options" class="nav-tab <?php echo $active_tab == 'display_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Display Options', 'wppb-demo-plugin' ); ?></a>
				<a href="?page=Dsbugreport_options&tab=social_options" class="nav-tab <?php echo $active_tab == 'social_options' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Social Options', 'wppb-demo-plugin' ); ?></a>
				<a href="?page=Dsbugreport_options&tab=input_examples" class="nav-tab <?php echo $active_tab == 'input_examples' ? 'nav-tab-active' : ''; ?>"><?php _e( 'Input Examples', 'wppb-demo-plugin' ); ?></a>
			</h2>
			...
			<form method="post" action="options.php">
				...
				if( $active_tab == 'display_options' ) {
					...
					settings_fields( 'Dsbugreport_display_options' );
					do_settings_sections( 'Dsbugreport_display_options' );

				} elseif( $active_tab == 'social_options' ) {

					settings_fields( 'Dsbugreport_social_options' );
					do_settings_sections( 'Dsbugreport_social_options' );

				} else {

					settings_fields( 'Dsbugreport_input_examples' );
					do_settings_sections( 'Dsbugreport_input_examples' );
	...
	public function general_options_callback() {
		$options = get_option('Dsbugreport_display_options');
		var_dump($options);
	...
	public function social_options_callback() {
		$options = get_option('Dsbugreport_social_options');
		var_dump($options);
	...
	public function input_examples_callback() {
		$options = get_option('Dsbugreport_input_examples');
		var_dump($options);
	...
	public function initialize_display_options() {
		...
		if( false == get_option( 'Dsbugreport_display_options' ) ) {
			$default_array = $this->default_display_options();
			add_option( 'Dsbugreport_display_options', $default_array );
		}
		...
		add_settings_section(
			...
			'Dsbugreport_display_options'		                // Page on which to add this section of options
		);
		...
		add_settings_field(
			...
			'Dsbugreport_display_options',	            // The page on which this option will be displayed
	...
	public function initialize_social_options() {
		delete_option('Dsbugreport_social_options');
		if( false == get_option( 'Dsbugreport_social_options' ) ) {
			$default_array = $this->default_social_options();
			update_option( 'Dsbugreport_social_options', $default_array );
		} // end if
		...
		add_settings_section(
			...
			'Dsbugreport_social_options'		// Page on which to add this section of options
		);
	...
	public function initialize_input_examples() {
		//delete_option('Dsbugreport_input_examples');
		if( false == get_option( 'Dsbugreport_input_examples' ) ) {
			$default_array = $this->default_input_options();
			update_option( 'Dsbugreport_input_examples', $default_array );
		} // end if
	...
	public function toggle_header_callback($args) {
		...
		$html = '<input type="checkbox" id="show_header" name="Dsbugreport_display_options[show_header]" value="1" ' . checked( 1, isset( $options['show_header'] ) ? $options['show_header'] : 0, false ) . '/>';
	...
	public function toggle_content_callback($args) {
		...
		$html = '<input type="checkbox" id="show_content" name="Dsbugreport_display_options[show_content]" value="1" ' . checked( 1, isset( $options['show_content'] ) ? $options['show_content'] : 0, false ) . '/>';
	...
	public function toggle_footer_callback($args) {
		...
		$html = '<input type="checkbox" id="show_footer" name="Dsbugreport_display_options[show_footer]" value="1" ' . checked( 1, isset( $options['show_footer'] ) ? $options['show_footer'] : 0, false ) . '/>';
	...
	public function twitter_callback() {
		...
		// Render the output
		echo '<input type="text" id="twitter" name="Dsbugreport_social_options[twitter]" value="' . $url . '" />';
	...
	public function facebook_callback() {
		...
		// Render the output
		echo '<input type="text" id="facebook" name="Dsbugreport_social_options[facebook]" value="' . $url . '" />';
	...
	public function googleplus_callback() {
		...
		// Render the output
		echo '<input type="text" id="googleplus" name="Dsbugreport_social_options[googleplus]" value="' . $url . '" />';
	...
	public function input_element_callback() {
		...
		// Render the output
		echo '<input type="text" id="input_example" name="Dsbugreport_input_examples[input_example]" value="' . $options['input_example'] . '" />';
	...
	public function textarea_element_callback() {
		...
		// Render the output
		echo '<textarea id="textarea_example" name="Dsbugreport_input_examples[textarea_example]" rows="5" cols="50">' . $options['textarea_example'] . '</textarea>';
	...
	public function checkbox_element_callback() {
		...
		$html = '<input type="checkbox" id="checkbox_example" name="Dsbugreport_input_examples[checkbox_example]" value="1"' . checked( 1, $options['checkbox_example'], false ) . '/>';
		$html .= '&nbsp;';
	...
	public function radio_element_callback() {
		...
		$html = '<input type="radio" id="radio_example_one" name="Dsbugreport_input_examples[radio_example]" value="1"' . checked( 1, $options['radio_example'], false ) . '/>';
		$html .= '&nbsp;';
		$html .= '<label for="radio_example_one">Option One</label>';
		$html .= '&nbsp;';
		$html .= '<input type="radio" id="radio_example_two" name="Dsbugreport_input_examples[radio_example]" value="2"' . checked( 2, $options['radio_example'], false ) . '/>';
		$html .= '&nbsp;';
	...
	public function select_element_callback() {
		...
		$html = '<select id="time_options" name="Dsbugreport_input_examples[time_options]">';
